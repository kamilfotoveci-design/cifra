(() => {
  ...
  const copy = {
    SK: {
      ...
      heroTitle: 'Faktúry bez stresu. Peniaze načas.',
      ...
      securityCopy: 'Toto sú konkrétne veci, ktoré VYSTAV robí s tvojimi dátami, nič viac a nič menej.',
      ...
      finalTitle: 'Prvá faktúra môže byť hotová ešte dnes.', finalCopy: 'Vytvor účet, doplň firemné údaje a VYSTAV ťa prevedie zvyškom.',
      ...
      startAccount: 'Vytvoriť účet', footer: 'Faktúry, ktoré máš poruke.',
    ...
    CZ: {
      ...
      heroTitle: 'Faktury bez stresu. Peníze včas.',
      ...
      securityCopy: 'Toto jsou konkrétní věci, které VYSTAV dělá s tvými daty, nic víc a nic míň.',
      ...
      finalTitle: 'První faktura může být hotová ještě dnes.', finalCopy: 'Vytvoř účet, doplň firemní údaje a VYSTAV tě provede zbytkem.',
      ...
      startAccount: 'Vytvořit účet', footer: 'Faktury, které máš po ruce.',
